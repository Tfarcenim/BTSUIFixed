...
public final class Easings {
    ...
    private static final double TAU_OVER_THREE = MathUtils.TAU / 3D;
    private static final double TAU_OVER_FOUR_POINT_FIVE = MathUtils.TAU / 4.5D;
    ...
    public static float easeInOutElastic(float x) {
        ...
        if (x == 0F) {
            ...
            if (x < 0.5F) {
                return (float) (-(Math.pow(2D, 20D * x - 10D) * Math.sin((20D * x - 11.125D) * TAU_OVER_FOUR_POINT_FIVE)) / 2D);
            }
            else {
                return (float) ((Math.pow(2D, -20D * x + 10D) * Math.sin(20D * x - 11.125D) * TAU_OVER_FOUR_POINT_FIVE) / 2D + 1D);
            }
        }
    }
    ...
    public static float easeInOutBack(float x) {
        ...
        if (x < 0.5F) {
            ...
            return (float) ((Math.pow(2D * x - 2D, 2D) * (IN_OUT_BACK_CONSTANT_ONE * (x * 2D - 2D) + IN_OUT_BACK_CONSTANT) + 2D) / 2D);
        }
    }
